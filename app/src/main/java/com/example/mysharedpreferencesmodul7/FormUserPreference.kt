package com.example.mysharedpreferencesmodul7
...
import com.example.mysharedpreferencesmodul7.databinding.ActivityFormUserPreferenceBinding
...
class FormUserPreferenceActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private fun saveUser(
        name: String, email: String, age: String, phoneNo:
        String, isLoveMU: Boolean
    ) {
